...
var codes2 = [
        ...
        { code : '000403', name: '双林生物'},
        { code : '000404', name: '长虹华意'},
        { code : '000407', name: '胜利股份'},
        { code : '000408', name: '藏格控股'},
        { code : '000409', name: 'ST地矿'},
        { code : '000410', name: 'ST沈机'},
        ...
        { code : '000571', name: 'ST大洲'},
        { code : '000572', name: 'ST海马'},
        { code : '000573', name: '粤宏远Ａ'},
        { code : '000576', name: '广东甘化'},
        { code : '000581', name: '威孚高科'},
        { code : '000582', name: '北部湾港'},
        { code : '000584', name: '哈工智能'},
        { code : '000585', name: 'ST东电'},
        { code : '000586', name: '汇源通信'},
        { code : '000587', name: '金洲慈航'},
        { code : '000589', name: '贵州轮胎'},
        { code : '000590', name: '启迪古汉'},
        { code : '000591', name: '太阳能'},
        { code : '000592', name: '平潭发展'},
        { code : '000593', name: '大通燃气'},
        { code : '000595', name: '宝塔实业'},
        ...
        { code : '000668', name: '荣丰控股'},
        { code : '000669', name: '金鸿控股'},
        { code : '000670', name: 'ST盈方'},
        { code : '000671', name: '阳光城'},
        { code : '000672', name: '上峰水泥'},
        { code : '000673', name: '当代东方'},
        ...
        { code : '000736', name: '中交地产'},
        { code : '000737', name: 'ST南风'},
        ...
        { code : '002136', name: '安纳达'},
        { code : '002137', name: '麦达数字'},
        ...
        { code : '002145', name: '中核钛白'},
        { code : '002146', name: '荣盛发展'},
        { code : '002147', name: 'ST新光'},
        { code : '002148', name: '北纬科技'},
        { code : '002149', name: '西部材料'},
        { code : '002150', name: '通润装备'},
        ...
        { code : '002240', name: '威华股份'},
        { code : '002241', name: '歌尔股份'},
        { code : '002242', name: '九阳股份'},
        { code : '002243', name: '通产丽星'},
        { code : '002244', name: '滨江集团'},
        { code : '002245', name: '澳洋顺昌'},
        ...
        { code : '002322', name: '理工环科'},
        { code : '002323', name: 'ST百特'},
        { code : '002324', name: '普利特'},
        { code : '002325', name: '洪涛股份'},
        ...
        { code : '002496', name: '辉丰股份'},
        { code : '002497', name: '雅化集团'},
        { code : '002498', name: '汉缆股份'},
        { code : '002499', name: 'ST科林'},
        { code : '002500', name: '山西证券'},
        { code : '002501', name: 'ST利源'},
        { code : '002502', name: '鼎龙文化'},
        { code : '002503', name: '搜于特'},
        { code : '002504', name: '弘高创意'},
        { code : '002505', name: '大康农业'},
        ...
        { code : '002661', name: '克明面业'},
        { code : '002662', name: '京威股份'},
        { code : '002663', name: '普邦股份'},
        { code : '002664', name: '长鹰信质'},
        { code : '002665', name: '首航高科'},
        { code : '002666', name: '德联集团'},
        { code : '002667', name: '鞍重股份'},
        { code : '002668', name: '奥马电器'},
        { code : '002669', name: '康达新材'},
        { code : '002670', name: '国盛金控'},
        ...
        { code : '002739', name: '万达电影'},
        { code : '002740', name: '爱迪尔'},
        ...
        { code : '002775', name: '文科园林'},
        { code : '002776', name: '柏堡龙'},
        { code : '002777', name: '久远银海'},
        { code : '002778', name: '高科石化'},
        { code : '002779', name: '中坚科技'},
        { code : '002780', name: '三夫户外'},
        { code : '002781', name: '奇信股份'},
        ...
        { code : '002856', name: '美芝股份'},
        { code : '002857', name: '三晖电气'},
        { code : '002858', name: '力盛赛车'},
        ...
        { code : '300116', name: '坚瑞沃能'},
        { code : '300117', name: '嘉寓股份'},
        ...
        { code : '300309', name: '吉艾科技'},
        { code : '300310', name: '宜通世纪'},
        { code : '300311', name: '任子行'},
        { code : '300312', name: '邦讯技术'},
        { code : '300313', name: '天山生物'},
        ...
        { code : '300385', name: '雪浪环境'},
        { code : '300386', name: '飞天诚信'},
        { code : '300387', name: '富邦股份'},
        { code : '300388', name: '国祯环保'},
        { code : '300389', name: '艾比森'},
        { code : '300390', name: '天华超净'},
        { code : '300391', name: '康跃科技'},
        { code : '300392', name: '腾信股份'},
        ...
        { code : '300526', name: '中潜股份'},
        { code : '300527', name: '中国应急'},
        { code : '300528', name: '幸福蓝海'},
        { code : '300529', name: '健帆生物'},
        { code : '300530', name: '达志科技'},
        ...
        { code : '300539', name: '横河模具'},
        { code : '300540', name: '深冷股份'},
        ...
        { code : '300668', name: '杰恩设计'},
        { code : '300669', name: '沪宁股份'},
        { code : '300670', name: '大烨智能'},
        { code : '300671', name: '富满电子'},
        ...
        { code : '600090', name: '同济堂'},
        { code : '600091', name: 'ST明科'},
        { code : '600093', name: '易见股份'},
        { code : '600094', name: '大名城'},
        { code : '600095', name: '哈高科'},
        ...
        { code : '600279', name: '重庆港九'},
        { code : '600280', name: '中央商场'},
        { code : '600281', name: '太化股份'},
        ...
        { code : '600393', name: '粤泰股份'},
        { code : '600395', name: '盘江股份'},
        { code : '600396', name: 'ST金山'},
        { code : '600397', name: '安源煤业'},
        { code : '600398', name: '海澜之家'},
        { code : '600399', name: 'ST抚钢'},
        ...
        { code : '600515', name: '海航基础'},
        { code : '600516', name: '方大炭素'},
        { code : '600517', name: '置信电气'},
        ...
        { code : '600555', name: '海航创新'},
        { code : '600556', name: 'ST慧球'},
        ...
        { code : '600684', name: '珠江实业'},
        { code : '600685', name: '中船防务'},
        { code : '600686', name: '金龙汽车'},
        { code : '600687', name: 'ST刚泰'},
        ...
        { code : '600698', name: 'ST天雁'},
        { code : '600699', name: '均胜电子'},
        { code : '600701', name: 'ST工新'},
        ...
        { code : '600766', name: '园城黄金'},
        { code : '600767', name: 'ST运盛'},
        ...
        { code : '603555', name: '贵人鸟'},
        { code : '603556', name: '海兴电力'},
        { code : '603557', name: '起步股份'},
...
module.exports.codes1 = codes1;
module.exports.codes2 = codes2;