...
var df  = {
    ...
    url : function(){ return 'curl -A "User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:32.0) Gecko/20100101 Firefox/32.0"  --cookie "'+ this.cookie() +'" "http://myfavor.eastmoney.com/v4/webouter/as?appkey=d41d8cd98f00b204e9800998ecf8427e&cb=jQuery33103190186058732998_165458125273&g=1&sc=_zero_%24_code_&_=_time_" --referer http://quote.eastmoney.com/' },
    ...
    url_delete :function() {return ' curl --cookie "'+ this.cookie() +'" "http://myfavor.eastmoney.com/v4/webouter/dslot?appkey=d41d8cd98f00b204e9800998ecf8427e&cb=jQuery33108123426252924042_1655431990230&g=1&scs=_zero_%24_code_&_=_time_"  --referer http://quote.eastmoney.com/'},
...
//循环定时执行
var ForX = async (miao,obj)=>{
    let ZxgArr = await getZXG();           //自选股
    let Exsit = await myStockExist(obj);    //已经存在的股
    let _miao_ = miao == null ? 2000 : miao;
    let url_add = obj.url();
    let url_del = obj.url_delete();
